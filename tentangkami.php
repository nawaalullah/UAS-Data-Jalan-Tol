            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active" style="background-image: url('uploads/Jalan_Tol_Cipularang.jpeg');">
                    <div class="carousel-caption-left">
                        ...
                        <p class="fs-5"> <span class="text-danger fw-bold"></span> <span
                                style="text-shadow:2px 2px #000;"></span></p>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7">
                    ...
                    <p class="about-text">
                        ...
                        dengan pangsa pasar sebesar 45% untuk panjang jalan tol komersial yang telah beroperasi (±1.286
                        km). Dengan pengalaman selama lebih dari 46 tahun, Jasa Marga saat ini mengelola 36 konsesi
                        jalan tol dengan total panjang jalan 1.736 km.
                    </p>
                </div>
            </div>
        </div>
